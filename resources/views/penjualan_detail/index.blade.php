...
@push('css')
        ...
        <div class="col-lg-12">
            <div class="box">
                ...
                <div class="box-footer">
                    <button type="submit" id="simpan_transaksi"
                        class="btn btn-primary btn-sm btn-flat pull-right btn-simpan">
    ...
    @includeIf('penjualan_detail.produk') @includeIf('penjualan_detail.member')
