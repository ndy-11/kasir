        ...
        <form action="" method="POST" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="tgl_kdl" class="col-lg-2 col-lg-offset-1 control-label">Kadaluarsa</label>
                        <div class="col-lg-6">
                        <input type="date" name="tgl_kdl" id="tgl_kdl" class="form-control" required value="0">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
